package com.sweet.cms.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "sweet-admin\\src\\main\\java";
		final String viewOutputDir = "sweet-admin\\src\\main\\webapp\\WEB-INF\\views\\admin";
		...
		strategy.setInclude(new String[] { "tbl_cms_topic_commodity" }); // 需要生成的表
		...
		pc.setParent("com.sweet.cms"); // 自定义包路径
