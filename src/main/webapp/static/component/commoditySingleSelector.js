var commoditySingleSelector={
	open:function(options,callback){
		var defaults = {
        	...
        	height:640,
        	closabled:true,
        	url:'/component/queryCommodityList.sc?single=yes'
	    };
    	...
    	openwindow(opts.url,opts.width,opts.height,opts.title,function(){
			...
			checkObj.each(function(index, element) {
			   ...
			   for(var i=0;i<vals.length;i++)
			   {
				   ...
				   +'"commodityStatus":"'+vals[10]+'","inventoryNumber":"'+vals[11]+'","brandName":"'+vals[12]+'","activePrice":"0"';
			   }
			   str+=val+'}';
