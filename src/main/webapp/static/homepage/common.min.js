...
$("body").on("mouseover",".list_table tbody tr,.list-d-table tbody tr",function(){$(this).addClass("on")})
$("body").on("mouseout",".list_table tbody tr,.list-d-table tbody tr",function(){$(this).removeClass("on")});
...
$('.menu_wrap').on('click','ul li ul li span.tree-title',function()
{
