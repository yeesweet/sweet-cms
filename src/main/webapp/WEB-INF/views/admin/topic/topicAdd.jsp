    ...
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="topicAddForm" method="post">
            <table class="grid">
                ...
                <tr>
                    <td>活动排序</td>
                    <td><input name="sortNo" type="text" placeholder="" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td>列表排序</td>
                    <td><input name="listSort" type="text" placeholder="" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
            </table>
        </form>
    </div>
