...
<div class="container">
	...
	<div class="list_content">
        ...
        <div class="top clearfix">
			    <ul class="tab">
			        <li class="curr"><span>编辑优购快报</span></li>
			    </ul>
			  </div>
        <!--当前位置end-->
	<!--主体start--> 
	              ...
	              <div class="lunboimglist">
                  	<#if cmsModule.moduleDetails??>
						<#list cmsModule.moduleDetails as cmsModuleDetail>
                  			<div class="lunboimgshow article">
                  			  <p class="megP">
								<#if cmsModuleDetail.imgUrl?? && cmsModuleDetail.imgUrl != "">    
		                    		<img id="fl104${cmsModuleDetail_index+1}" src="${cmsModuleDetail.imgUrl}" />
								<#else>         
		                    		<img id="fl104${cmsModuleDetail_index+1}" src="/images/homepage/icon1.jpg"/>
		                    	</#if>
		                    	<span id="message${cmsModuleDetail_index+1}" title="${cmsModuleDetail.title}">
		                    		<#if cmsModuleDetail.title?? && cmsModuleDetail.title != "" && (cmsModuleDetail.title?length gt 24)> 
		                    			${cmsModuleDetail.title?substring(0,24)}…
		                    		<#else>
	          		...
	          		<#list cmsModule.moduleDetails as cmsModuleDetail>
	          			<#if cmsModuleDetail??><div class="LbArea">
							<div class="upload" id="upload${cmsModuleDetail_index+1}">
								...
								<p class="title"><span class="red">*</span>快报标题：
										<input id="title${cmsModuleDetail_index+1}" class="ipt_text" type="text" style="width:300px;"
											   value="${cmsModuleDetail.title }" name="moduleDetails[${cmsModuleDetail_index}].title"/>(50个字以内)
								</p>
