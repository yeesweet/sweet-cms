    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="pageManagerEditForm" method="post">
            <table class="grid">
                <tr>
                    <td>商家名称</td>
                    <td><input name="id" type="hidden"  value="${pageManager.id}">
                    <input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox" data-options="required:true" value="${pageManager.name}"></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
