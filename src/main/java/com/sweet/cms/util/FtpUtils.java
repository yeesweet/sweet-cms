...
//                    infileclose(is);
    ...
    public static void main(String agrs[]) {
        ...
        try {
            //下载
//			ftpUtil.download("/test/test5.xls", "D:\\test5.xls");

            List<String> list = ftpUtil.getnames("/test");
            ftpUtil.downloadFile("/test", "D:\\test\\", list);

            //上传
//			ftpUtil.upload("D:\\PicConvertor.jar", "/test/aaa.jar");
//			ftpUtil.uploadFiles("D:\\tmp\\soft", "/test");
//			List<String> name=ftpUtil.uploadFiles("D:\\tmp\\soft", "/test");
            //从数据流中获取
//			InputStream inputStream = ftpUtil.getFtpInputStream("/test/test.xls");
